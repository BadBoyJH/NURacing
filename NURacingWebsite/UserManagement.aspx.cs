...
namespace NURacingWebsite
{
    public partial class UserManagement : System.Web.UI.Page
    {
            ...
            TextBox userRoleTxtBx = new TextBox();
        ...
        {            
                ...
                createUserFrm.Controls.Add(userRoleTxtBx);
                createUserFrm.Controls.Add(new LiteralControl("</p>"));
                ...
                //createUserFrm.Controls.Add(createSubmitBtn());
        }

        protected void submitCreateUserBtn_Click(object sender, EventArgs e)
        {
                BusinessLogicLayer.User.addUser(userNameTxtBx.Text, passwordTxtBx.Text, userRoleTxtBx.Text, givenNameTxtBx.Text, surnameTxtBx.Text, emailTxtBx.Text, stdNumTxtBx.Text, gradYearTxtBx.Text, degreeNameTxtBx.Text, medicareNumTxtBx.Text, allergiesTxtBx.Text, medicalCondTxtBx.Text, dietryReqTxtBx.Text, indemSignChkBx.Checked,
        ...
        //protected Button createSubmitBtn()
        //{
        //    //submitBtn = new Button();
        //    //submitBtn.Text = "SUBMIT";
        //    //submitBtn.CssClass = "takeFiveBtn";
        //    //submitBtn.Click += new EventHandler(submitCreateUserBtn_Click);
        //    //return submitBtn;
        //}
    }
}