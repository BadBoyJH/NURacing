                ...
                <div class="col1">
                    <form id="login" runat="server">
                        ...
                        <div id="loginForm" class="loginForm">
                            <p runat="server" id="error" class="pUserFeedbackFail" visible="false">Incorrect Username/Password entered.</p>
                            <table border="0" style="margin-left: auto; margin-right: auto; text-align: right;">
                                <tr>
                                    <td>
                                        <asp:Label runat="server" ID="lblUsername" CssClass="p">Username: </asp:Label></td>
                                    <td>
                                        <asp:TextBox runat="server" Width="100%" ID="UsernameTxtBx" CssClass="textareaPassword" BackColor="#2D2D2D" Font-Names="Lucida Sans Unicode" Font-Size="11pt" ForeColor="#7E7E7E" /></td>
                                </tr>
                                <tr>
                                    <td class="auto-style1">
                                        <asp:Label runat="server" ID="lblPassword" CssClass="p">Password: </asp:Label></td>
                                    <td class="auto-style1">
                                        <asp:TextBox runat="server" TextMode="Password" Width="100%" ID="PassTxtBx" CssClass="textareaPassword" BackColor="#2D2D2D" Font-Names="Lucida Sans Unicode" Font-Size="11pt" ForeColor="#7E7E7E" /></td>
                                </tr>
